        ...
        <div className="p-5 content bg-whitesmoke text-center">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group row pb-3">
                    ...
                    <img src={chess.image_url} height="200px" alt={chess.name} style={{borderRadius:"200px", display:"flex"}}/>
                    </div>
                </div>
                <button type="submit" className="btn btn-outline-dark btn-lg">Módosítás</button>
            </form>
        </div>
    );
    }
